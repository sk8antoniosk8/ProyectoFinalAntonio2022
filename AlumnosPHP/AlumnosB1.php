      ...
      <ul>
        ...
        if($folder1 = opendir($dir1)){
          while ($archivo1 = readdir($folder1)) {
            ...
            echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ComprensiónAuditiva/$archivo1'>".$archivo1."</a><br><br>";
           }
          }
        } ?>
        ...
        if($folder2 = opendir($dir2)){
          while ($archivo2 = readdir($folder2)) {
            ...
            echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ComprensiónLectora/$archivo2'>".$archivo2."</a><br><br>";
           }
          }
        } ?>
        ...
        if($folder3 = opendir($dir3)){
          while ($archivo3 = readdir($folder3)) {
            ...
            echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo3'>".$archivo3."</a><br><br>";
           }
          }
        } ?>
        ...
        if($folder4 = opendir($dir4)){
          while ($archivo4 = readdir($folder4)) {
            ...
            echo "&nbsp-<a href='/ProyectoFinal/archivosB1/ProduccionEscrita/$archivo4'>".$archivo4."</a><br>";
           }
          }
        } ?>
